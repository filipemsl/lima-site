import { a as Rt, e as Nt, h as At, i as Ct } from "./chunk-U3GQEZQR.mjs";
import { r as Ot, s as Dt, y as jn } from "./chunk-VHFKZWVR.mjs";
import { a as Hn, b as vt, c as $n, h as Gn } from "./chunk-KPMZENE5.mjs";
...
function ug({ name: e, security: t }) {
  To ||
    ((To = !0),
    Hn(({ error: n, tags: r, extras: o, critical: i }) => {
      Ee((s) => {
        (s.setTags(r), o && s.setExtras(o), i && s.setLevel("fatal"), Te(n));
      });
    }),
    (Rt.log = Gn(e).extend("services")),
    t.allowChannelToParentWithOrigin &&
      At.initializeTrustedOrigin(t.allowChannelToParentWithOrigin),
    t.allowChannelToOpenerWithOrigin &&
      Ct.initializeTrustedOrigin(t.allowChannelToOpenerWithOrigin),
    window.addEventListener("pagehide", () => {
      (it(),
        Rt.log.debug("Unregistering services to parent/opener frame when unloading"),
        Nt.shared().unregister(At).catch(vt),
        Nt.shared().unregister(Ct).catch(vt));
    }));
}
export {
  Ee as a,
...
//# sourceMappingURL=https://app.framerstatic.com/chunk-HM2MW6VA.mjs.map
