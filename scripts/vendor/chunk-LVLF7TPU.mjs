import { d as m } from "./chunk-XDMJRBO3.mjs";
...
import { e as c, h as M, j as h } from "./chunk-U3GQEZQR.mjs";
import { p as y, u as k } from "./chunk-VHFKZWVR.mjs";
...
function me({ children: i, forceDarkMode: a = !1, setDocumentColorScheme: s = !0 }) {
  ...
  return (
    ...
    (0, S.jsx)(O.Provider, { value: e, children: (0, S.jsx)(g, { enabled: k(), children: i }) })
  );
}
export { O as a, me as b };
//# sourceMappingURL=https://app.framerstatic.com/chunk-LVLF7TPU.mjs.map
