...
import { b as y } from "./chunk-PKVU47C6.mjs";
...
import { f as tt } from "./chunk-5IZEK7XN.mjs";
import {
  Ah as Ze,
  Be as Q,
  Cg as f,
...
import { o as T } from "./chunk-WCMBEYRV.mjs";
...
import { j as pe } from "./chunk-HM2MW6VA.mjs";
...
function Go(i) {
  let e = i[0];
  return e?.filename ? oe(e, e.preferredSize) : null;
}
function re(i, e, t = "timed out") {
...
var se = class {
    ...
    async uploadVideo(
      ...
      try {
        let a = t ? B : (u) => y(u),
          s = await Promise.all([
            re(ae(e), 1e4, "Measuring the video took more than 10 seconds"),
...
//# sourceMappingURL=https://app.framerstatic.com/chunk-N5IX35J7.mjs.map
