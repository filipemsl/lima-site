...
import {
  ...
  xd as Le,
  yd as jr,
} from "./chunk-OPBZL2GY.mjs";
import { c as Se, e as z } from "./chunk-JHGFSY77.mjs";
import { Bb as Gr, tb as Oe, ub as De } from "./chunk-ZDPZB4OV.mjs";
import {
  $f as ht,
  Au as Ct,
  Cv as Br,
...
import { o as st } from "./chunk-WCMBEYRV.mjs";
...
function Zr(e, t, r, s, i) {
  return t === r || ((t = Jr(e, t)), (r = Jr(e, r)), w(t, r))
    ? !1
    : (t === void 0 ? (s._deleted || (s._deleted = []), s._deleted.push(e)) : (s[$r(e)] = t),
      r === void 0 ? (i._deleted || (i._deleted = []), i._deleted.push(e)) : (i[$r(e)] = r),
      !0);
}
function en(e, t, r, s) {
  let i = !1,
    o = {},
    l = {};
  for (let T in s) i = Zr(T, r[T], s[T], l, o) || i;
  for (let T in r) T in s || (i = Zr(T, r[T], s[T], l, o) || i);
  if (i) return { id: Is(e, t), from: l, to: o };
}
function gs(e, t, r) {
  if (!(Q(t) || Q(r))) return;
  let s = t ? t.id : r ? r.id : "",
...
function rn(e, t, r, s) {
  ...
  return zr(i)
    ? (F(Fr(t), "Invalid EntityReferenceNode ID: " + t), new i({ ...be(s), id: t }))
    : new i({ ...be(s), id: t });
}
function nn(e) {
...
function Rs(e) {
  let t = "styledText";
  return e != null && typeof e[t] == "object" && e[t] !== null && sn(e[t]);
}
function an(e, t) {
  e.has(t) && e.remove(t);
}
...
function Ss(e, t) {
  ...
  return (
    ...
    (t === "replicaInfo"
      ...
      : (Re(r) && ((r = r.toJS()), sn(r) && t === "styledText" && delete r.cached), r))
  );
}
...
function Os(e, t, r, s = !1) {
  let i = !1;
  for (let [p, C] of Object.entries(r))
    if (p === "_deleted" || !w(C, Ss(t, p))) {
      i = !0;
      break;
    }
  if (!i) return null;
...
function Ls(e, t, r) {
  ...
  Ps(o, s) || (t.asDraft(e).children = new Er(s));
}
function Ps(e, t) {
      ...
      for (; t.length > 0; ) {
        ...
        for (let o = 0, l = t.length; o < l; o++) {
          ...
          T.added
            ...
            : T.removed || (bt(e, T.id, T.to) ? i.push(T) : (bs(e, T, s), ae(e, u, T)));
        }
...
var Bs = { id: !0, cache: !0, children: !0, mutable: !0, update: !0, styledText: !0, _deleted: !0 },
  ks = { parentid: !0, replicaInfo: !0, originalid: !0, duplicatedFrom: !0 };
function xs(e, t) {
  let r = e.length;
  if (r !== t.length) return !1;
  ...
  if ((r && (delete i.to.parentid, delete i.from.parentid), !!o))
    return (
      (t instanceof vr ||
        ...
        t instanceof Hr ||
        t instanceof Kr ||
        (i.added && t instanceof Yr) ||
        (i.added && t instanceof Qr) ||
        t instanceof Vr ||
        t instanceof Wr) &&
        (i.ignoreInUndo = !0),
      i
...
function Hs(e, t, r) {
  ...
  for (let u of T) {
    if (o) {
      ...
      if (u === "children") {
        (Fs(r, e.children, t.children), (r.fromChildren || r.toChildren) && (l = !0));
        continue;
      }
      if (Bs[u]) continue;
    }
...
ie.setGeneric("diffNodes", Hs);
ie.setGeneric("updateNode", Os);
function Mt(e) {
...
var on = ["contentManagementSyncState", "save", "transient"];
function Zc(e) {
  return on.some((t) => t === e);
}
function Us(e) {
  let t = Mt(e);
  for (let r of on) {
...
function yt(e, t, r) {
  ...
  if (e.added) {
    if (!nn(e.to)) return;
    if (!t.has(e.id)) {
      let T = rn(t.getCanvasTreeProxy(), e.id, e.added, e.to);
...
function Gs(e, t, r, s, i, o) {
  ...
  for (let { itemKey: _, transforms: p } of l) {
    ...
    let D = [],
      ...
      x = ke(_, S, r, s, o, O);
    for (let R of p) at(R.name) && (x = Qs(R, x, S, I));
...
function Xs(e, t) {
  if (e.length !== 0)
    return e.reduce(
      (r, s) => {
        let i = js(s.expression, s.optionalVariables, t);
...
function zs(e, t) {
  ...
  let r = e.reduce(
    (o, l) => {
      let T = qs(l.expression, l.optionalVariables, t);
...
function Al(e, t, r, s, i) {
  let o = {},
    l = new Set(),
    T = Ws(e);
  e.collectionFilters && (o.where = Gs(e, t, l, T, s, i));
  let u = t.get(e.getPrimaryId());
  F(u, "Control map of repeater must exist");
  let A = Js(e, u, l, T, s, i);
  ...
  let _ = ti(u, r, l, T, i);
  return { from: ei(e.dataIdentifier, u, l, T, i), select: _, ...o };
}
...
function si(e) {
  return !J(e) || e.type !== "object"
    ...
    : e.value === null
      ? !0
      : Object.values(e.value).every(ni);
}
function bl(e) {
  return er(e) && e.every((t) => Dr(t) && si(t));
}
var ii = /^(.*?)(?:([^/])\.([^/.]+))?$/;
function Bl(e) {
  let t = e.match(ii);
...
function He(e) {
  return (e >= 64976 && e <= 65007) || ai.has(e);
}
var h;
(function (e) {
  ...
  Ue = class {
    ...
    _processSurrogate(t) {
      if (this.pos !== this.html.length - 1) {
        ...
        if (Tn(r)) return (this.pos++, this._addGap(), En(t, r));
...
var m = n,
  ...
  Gl = new Set([E.STYLE, E.SCRIPT, E.XMP, E.IFRAME, E.NOEMBED, E.NOFRAMES, E.PLAINTEXT]);
var c;
(function (e) {
  ((e[(e.DATA = 0)] = "DATA"),
    (e[(e.RCDATA = 1)] = "RCDATA"),
...
function fn(e) {
  return mn(e) || e === a.SOLIDUS || e === a.GREATER_THAN_SIGN;
}
function ui(e) {
  return e === a.NULL
...
var le = class {
  ...
  _emitCodePoint(t) {
    let r = mn(t) ? N.WHITESPACE_CHARACTER : t === a.NULL ? N.NULL_CHARACTER : N.CHARACTER;
  ...
  _stateScriptDataDoubleEscapeStart(t) {
    if (this.preprocessor.startsWith(M.SCRIPT, !1) && fn(this.preprocessor.peek(M.SCRIPT.length))) {
      this._emitCodePoint(t);
  ...
  _stateCharacterReference() {
    ...
    t === 0
      ? ((this.preprocessor.pos = this.entityStartPos),
        ...
        (this.state =
          !this._isCharacterReferenceInAttribute() && un(this.preprocessor.peek(1))
...
var Cn = new Set([n.DD, n.DT, n.LI, n.OPTGROUP, n.OPTION, n.P, n.RB, n.RP, n.RT, n.RTC]),
  pn = new Set([...Cn, n.CAPTION, n.COLGROUP, n.TBODY, n.TD, n.TFOOT, n.TH, n.THEAD, n.TR]),
  Ye = new Set([n.APPLET, n.CAPTION, n.HTML, n.MARQUEE, n.OBJECT, n.TABLE, n.TD, n.TEMPLATE, n.TH]),
  fi = new Set([...Ye, n.OL, n.UL]),
  mi = new Set([...Ye, n.BUTTON]),
  _n = new Set([n.ANNOTATION_XML, n.MI, n.MN, n.MO, n.MS, n.MTEXT]),
  An = new Set([n.DESC, n.FOREIGN_OBJECT, n.TITLE]),
  pi = new Set([n.TR, n.TEMPLATE, n.HTML]),
  _i = new Set([n.TBODY, n.TFOOT, n.THEAD, n.TEMPLATE, n.HTML]),
  Ai = new Set([n.TABLE, n.TEMPLATE, n.HTML]),
  Ci = new Set([n.TD, n.TH]),
  Ve = class {
    ...
    hasInListItemScope(t) {
      return this.hasInDynamicScope(t, fi);
    }
    hasInButtonScope(t) {
    ...
    generateImpliedEndTagsThoroughly() {
      for (; this.currentTagId !== void 0 && pn.has(this.currentTagId); ) this.pop();
    }
    generateImpliedEndTagsWithExclusion(t) {
      for (; this.currentTagId !== void 0 && this.currentTagId !== t && pn.has(this.currentTagId); )
        this.pop();
    }
  };
var U;
...
var gn = "html",
  Ni = "about:legacy-compat",
  Ii = "http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd",
  Rn = [
  ...
  gi = [...Rn, "-//w3c//dtd html 4.01 frameset//", "-//w3c//dtd html 4.01 transitional//"],
  Ri = new Set([
    "-//w3o//dtd w3 html strict 3.0//en//",
    "-/w3c/dtd html 4.0 transitional/en",
    "html",
  ]),
  Sn = ["-//w3c//dtd xhtml 1.0 frameset//", "-//w3c//dtd xhtml 1.0 transitional//"],
  Si = [...Sn, "-//w3c//dtd html 4.01 frameset//", "-//w3c//dtd html 4.01 transitional//"];
function In(e, t) {
  return t.some((r) => e.startsWith(r));
}
function On(e) {
  return e.name === gn && e.publicId === null && (e.systemId === null || e.systemId === Ni);
}
function Dn(e) {
  if (e.name !== gn) return B.QUIRKS;
  let { systemId: t } = e;
  if (t && t.toLowerCase() === Ii) return B.QUIRKS;
  let { publicId: r } = e;
  if (r !== null) {
    if (((r = r.toLowerCase()), Ri.has(r))) return B.QUIRKS;
    let s = t === null ? gi : Rn;
    if (In(r, s)) return B.QUIRKS;
    if (((s = t === null ? Sn : Si), In(r, s))) return B.LIMITED_QUIRKS;
  }
  return B.NO_QUIRKS;
}
var Ln = { TEXT_HTML: "text/html", APPLICATION_XML: "application/xhtml+xml" },
  Di = "definitionurl",
  Li = "definitionURL",
  Pi = new Map(
    [
  ...
  if (t === f.MATHML && e === n.ANNOTATION_XML) {
    for (let s = 0; s < r.length; s++)
      if (r[s].name === V.ENCODING) {
        ...
        return i === Ln.TEXT_HTML || i === Ln.APPLICATION_XML;
      }
  }
  return t === f.SVG && (e === n.FOREIGN_OBJECT || e === n.DESC || e === n.TITLE);
}
function bn(e, t, r, s) {
  return ((!s || s === f.HTML) && ki(e, t, r)) || ((!s || s === f.MATHML) && Bi(e, t));
}
var xi = "hidden",
  Fi = 8,
  Hi = 3,
...
var Ui = { startLine: -1, startCol: -1, startOffset: -1, endLine: -1, endCol: -1, endOffset: -1 },
  Fn = new Set([n.TABLE, n.TBODY, n.TFOOT, n.THEAD, n.TR]),
  Bn = { scriptingEnabled: !0, sourceCodeLocationInfo: !1, treeAdapter: k, onParseError: null },
  pe = class {
    ...
    _err(t, r, s) {
      ...
      let o = (i = t.location) !== null && i !== void 0 ? i : Ui,
        l = {
          code: r,
    ...
    onEndTag(t) {
      ((this.skipNextNewLine = !1),
        (this.currentToken = t),
        this.currentNotInHTML ? po(this, t) : this._endTagOutsideForeignContent(t));
    }
...
function wt(e, t) {
  for (let r = 0; r < Fi; r++) {
    ...
    let o = Yi(e, i, s.element),
      l = e.openElements.getCommonAncestor(s.element);
    (e.treeAdapter.detachNode(o), l && Wi(e, l, o), Qi(e, i, s));
  }
}
function Ut(e, t) {
...
function Xi(e, t) {
  ...
  let r = t.forceQuirks ? B.QUIRKS : Dn(t);
  (On(t) || e._err(t, h.nonConformingDoctype),
...
function wn(e) {
  let t = ve(e, V.TYPE);
  return t != null && t.toLowerCase() === xi;
}
function _a(e, t) {
  (e._reconstructActiveFormattingElements(),
    e._appendElement(t, f.HTML),
...
function y(e, t) {
  switch (t.tagID) {
    ...
    case n.NOSCRIPT: {
      e.options.scriptingEnabled ? kn(e, t) : xn(e, t);
      break;
    }
    case n.PLAINTEXT: {
      Ta(e, t);
...
function Ma(e, t) {
  e.openElements.hasInScope(n.BODY) && ((e.insertionMode = d.AFTER_BODY), qn(e, t));
}
function Ba(e, t) {
  let r = t.tagID;
...
function Vn(e, t) {
  e.tmplInsertionModeStack.length > 0 ? jn(e, t) : Yt(e, t);
}
function Ya(e, t) {
  var r;
  (t.tagID === n.SCRIPT &&
...
function Ht(e, t) {
  if (e.openElements.currentTagId !== void 0 && Fn.has(e.openElements.currentTagId))
    switch (
...
var Kn = new Set([n.CAPTION, n.COL, n.COLGROUP, n.TBODY, n.TD, n.TFOOT, n.TH, n.THEAD, n.TR]);
function $a(e, t) {
  let r = t.tagID;
  Kn.has(r)
...
function to(e, t) {
  ...
  switch (r) {
    ...
    case n.THEAD:
    case n.TR: {
      e.openElements.hasInTableScope(r) && (e._closeTableCell(), Gn(e, t));
      break;
    }
    case n.BODY:
    case n.CAPTION:
...
function mo(e, t) {
  if (Pn(t)) ($n(e), e._startTagOutsideForeignContent(t));
  else {
    let r = e._getAdjustedCurrentElement(),
      s = e.treeAdapter.getNamespaceURI(r);
    (s === f.MATHML ? xt(t) : s === f.SVG && (yn(t), Ft(t)),
      Qe(t),
...
var _o = "data-framer-link",
  Zn = "data-framer-open-in-new-tab",
  es = "data-framer-smooth-scroll",
  Ao = "data-framer-click-tracking-id",
  ts = "data-framer-rel",
  Co = "data-framer-preserve-params",
  No = "framer-module",
  Io = "data-module-identifier",
  go = "data-module-props",
  Ro = "data-module-width",
  So = "data-module-alignment",
  Oo = /\s+/u;
function Je(e, t) {
  let r = Jn(e),
...
function Lo(e) {
  ...
  switch (e.tagName) {
    ...
    case "img":
      return rs(t, "image");
    case "video":
      return Wt(t, "framer-image") || t.get("src") ? rs(t, "video") : void 0;
    case No:
    case "template":
      return Bo(t);
    case "table":
...
function yo(e, t, r) {
  return { id: L(), type: "bulletedList", textDirection: Kt(t, r), childNodes: cs(e) };
}
function bo(e, t, r) {
  let s = Qo(t.get("start")) ?? 1,
    i = Vo(e, r);
  return {
    id: L(),
    type: "numberedList",
...
function rs(e, t) {
  ...
  if (t === "image") {
    let i = e.get("alt");
    i !== void 0 && (r.alt = i);
    let o = os(e.get("data-framer-width"));
    o !== void 0 && (r.pixelWidth = o);
    let l = os(e.get("data-framer-height"));
...
function xo(e) {
  let t = [];
  for (let r of re(e)) (r.tagName !== "td" && r.tagName !== "th") || t.push(Fo(r));
...
function ds(e) {
  ...
  if (r === void 0) return;
  let s = te(e.get(ts)) ?? te(e.get("rel")) ?? ss(e.get("rel")) ?? ss(e.get(ts)) ?? [],
    i = {
      id: L(),
      link: r,
      openInNewTab: te(e.get(Zn)) ?? as(e.get(Zn)),
      smoothScroll: te(e.get(es)) ?? as(e.get(es)),
      relValues: s,
    },
    o = e.get(Ao);
...
function Vo(e, t) {
  ...
  return (i && Ts(tt(i).get("style")).get("list-style-type")) || "decimal";
}
function te(e) {
...
function Go(e) {
  return !Ko(e) || typeof e.type != "string"
    ? !1
    : e.type === "url"
      ? typeof e.url == "string"
      : e.type === "webPage"
...
function Kd(e) {
  return typeof e == "string" ? Tt(e).length === 0 : H(e) ? !Xo(Z(e)) : !0;
}
function Xo(e) {
  return (
    yr(e, {
...
var zt = "[a-z1-9]+(?:-[a-z1-9]+)*",
  qo = `${zt}="[^"]*"`,
  $o = String.raw`(?:\s+${qo})*`,
  Jo = String.raw`<${zt}${$o}\s*>`,
  Zo = `(?:${Jo})+`,
  ec = String.raw`<\/\s*${zt}\s*>`,
  tc = `(?:${ec})+`,
  rc = "[^<>]*",
  hs = String.raw`\s*`,
  nc = new RegExp(`^${hs}${Zo}${rc}${tc}${hs}$`, "iu");
function lT(e) {
  return H(e)
    ? sc(e)
...
function oc(e, t) {
  return typeof e == "string" ? e : Gr(e, t);
}
function BT(e, t) {
...
//# sourceMappingURL=https://app.framerstatic.com/chunk-4IT36LEY.mjs.map
