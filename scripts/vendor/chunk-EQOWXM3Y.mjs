import { g as he, i as Ie } from "./chunk-CXCGDCAG.mjs";
import { Ka as le } from "./chunk-GIACR7SH.mjs";
import { a as K } from "./chunk-TXAVNZJR.mjs";
import {
  Ka as Le,
  Ma as xe,
  Na as ke,
...
import { r as Ce, s as de } from "./chunk-Q3T3SIQM.mjs";
import { b as we, j as Y, m as X } from "./chunk-WQ5PKPGC.mjs";
import { b as G } from "./chunk-PKVU47C6.mjs";
import { q as A } from "./chunk-4BL4NTEI.mjs";
import { k as ce, l as N, p as be } from "./chunk-4IT36LEY.mjs";
import { Md as Te, k as ve } from "./chunk-OPBZL2GY.mjs";
import { a as ye, h as Se } from "./chunk-5JQQYZG5.mjs";
import { Oh as $ } from "./chunk-UJYN5YU4.mjs";
import { a as J } from "./chunk-GBWZWM2Q.mjs";
import { o as ge } from "./chunk-WCMBEYRV.mjs";
import { a as F } from "./chunk-5WDLMAA7.mjs";
import { a as O } from "./chunk-HZLWYBUG.mjs";
import { b as pe } from "./chunk-LA34HORX.mjs";
import { a as Xe } from "./chunk-W774OHJB.mjs";
import { b as c, c as fe } from "./chunk-4JY5UMT2.mjs";
import { j as D } from "./chunk-HM2MW6VA.mjs";
import { c as W, h as S } from "./chunk-KPMZENE5.mjs";
import { e as Ye } from "./chunk-WLHSDIGQ.mjs";
function Q(a) {
...
var me = S("remote:sync"),
  ...
  Z = class {
    ...
    add(e, t, r, n) {
      ...
      return (
        me.debug("create CRDT rows message:", e.length, "inflight:", this.unconfirmed.size, o.seq),
    ...
    takePendingRetries(e) {
      ...
      for (let r of this.unconfirmed.values()) {
        let n = r.attempts > 0 ? Ke[r.attempts - 1] : 0;
        if (n === void 0 || e - r.lastAttemptAt < n) continue;
        (me.info("retrying unconfirmed update", { seq: r.seq, attempts: r.attempts }),
          r.attempts++,
          (r.lastAttemptAt = e));
        let o = ue(r);
        ((o.reasons = [r.reasons, Fe].filter(Boolean).join(" ")), t.push(o));
      }
      return t;
    }
    takeAllForReconnect(e) {
      ...
      for (let r of this.unconfirmed.values()) {
        ...
        let n = ue(r);
        ((n.reasons = [r.reasons, Fe].filter(Boolean).join(" ")), t.push(n));
      }
      return t;
    }
    confirm(e) {
      ...
      return (
        ...
        Qe(t) &&
          (me.info("confirm arrived for a retried update", { seq: e, attempts: t.attempts }),
...
function ue({ seq: a, rows: e, reasons: t, ts: r, appEnvironment: n }) {
  ...
  ee = class {
    ...
    checkRemoteVersion(e, t, r = this.treeVersion) {
      return (
        ...
        e <= r ? (L.debug(`ignoring old ${t}:`, e, " <= ", r), "ignore") : "apply"
      );
    }
    verify(e, t) {
      let r = this.committer.getTreeForVersion(e);
      if (!r) return (L.debug("verify: unable to find tree with version", e), !0);
      if (r.containsLocalEdits)
        return (L.debug("verify: unable verify an entry with local edits"), !0);
      let n = r.tree,
        o = n.computeTreeHash();
      if (o !== t) {
        if ((L.warn("verify: failed", o, "!==", t), t === 0)) return !0;
    ...
    handleConfirmMessage(e) {
      ...
      if (t.kind === "unknown") {
        L.warn("ignoring confirm for untracked seq:", e.seq);
        return;
      }
      t.kind === "duplicate" && L.info("duplicate confirm", { seq: e.seq, next: e.next });
...
var tt = { children: !0, contentHash: !0, parentid: !0, $keep: !0 };
function rt(a, e) {
  if (a !== "cached") return e;
}
function Ae(a) {
  if (a === void 0) return;
  let e = JSON.stringify(a, rt);
  if (e !== void 0) return JSON.parse(e);
}
function nt(a, e) {
  return F(a, e) ? !1 : a === void 0 || e === void 0 ? !0 : !F(Ae(a), Ae(e));
}
function Ve(a, e, t) {
  ...
  function s(m, y) {
    if ((o.add(m), (y += "." + m), !n.has(m))) ((i = !0), t.push("-node: " + y));
      ...
      for (let b of g) {
        if (b in tt) continue;
        let M = a.getObjectKey(m, b),
          E = e.getObjectKey(m, b);
        nt(M, E) && f.push(` .${b}: ${JSON.stringify(M)} != ${JSON.stringify(E)}`);
      }
      if (f.length > 0) {
        ((i = !0), t.push("!node: " + y));
...
var V = S("remote:connection"),
  ...
  Pe = class {
    constructor(e, t, r, n, o, i, s) {
      ...
      this.callbacks = o;
      this.localCache = i;
      (c(e instanceof Me, "tree updater must be a CrdtTreeCommitter"),
        (this.treeSync = new ee(e)),
        (this.treeSync.appEnvironment = s),
        (this.treeSync.waitingForTree = !0),
        !D.benchmarkSkipTreeVerify &&
          ge.isOn("verifyTreeOnCommit") &&
    ...
    handleTreeVerify(e, t, r) {
      ...
      let o = this.treeSync.committer.branches.getStore(ye).getHierarchy().computeTreeHash();
      if (o !== r) {
    ...
    applyCollectedRows(e, t) {
      ...
      ke(r.effectiveViewStore, r.tree, n);
    ...
    async verifyTreeWithServer() {
      ...
      let n = r.headers.get("etag") || "",
        o = Number.parseInt(n.match(ot)?.[1] ?? "0", 10);
    ...
    maybeSend(e) {
      ...
      if (this.treeSync.outbox.size >= st) return "postpone";
...
`)
    ...
    resetTreesForRecovery(e) {
      if (!this.loader) {
        ...
        return we({ version: ve, root: r }, this.componentLoader, t);
      }
...
function ut(a) {
  return Math.min(dt * 2 ** a, je);
}
function He(a, e) {
  let t = 1 - Be + e() * Be * 2;
  return Math.min(Math.round(a * t), je);
}
function ft(a, e, t = Math.random) {
  return a === "ReconnectToNewServer"
    ? { delay: He(ct, t), nextReconnectAttempt: e }
    : { delay: He(ut(e), t), nextReconnectAttempt: e + 1 };
}
function gr({ url: a, documentConnection: e, tunnel: t, getSubprotocols: r }) {
  ...
  let f = (0, v.useCallback)(() => {
    ...
    p = (0, v.useCallback)(async () => {
      ...
      function u(w) {
        l.current === void 0 &&
          (l.current = window.setTimeout(() => {
            ((l.current = void 0),
              navigator.onLine && ((document.hidden && !D.isApiPlugin) || p()));
          }, w));
      }
      let g = new URL(s.current);
      if (
        (g.searchParams.set("v", ht.toString()),
        g.searchParams.set("tunnel", t || ""),
        g.searchParams.set("source", "project"),
        Te() && g.searchParams.set("mode", "crdt"),
        e.treeSchema <= 0)
      )
        return;
      ...
      let b = await m.current?.().catch((w) => {
        x.warn("Error resolving websocket subprotocols:", w);
      });
      if (!d.current || n.current) return;
      x.debug("connecting to", g.href);
      let M = new WebSocket(g.href, b),
        E = new te(),
        ae = { ws: M, stats: E, clientClosed: !1 };
      e.setSocketStats(E);
      let q = 0,
        j = 0;
        ...
        (x.debug("open"),
          ...
          (q = window.setInterval(() => {
            if (
              ...
              return;
            let w = "ping {}";
            (M.send(w), E.sent("ping", w));
          }, 1e3)));
        for (let w of i.current.onConnect)
          try {
            w(o.current);
          } catch (R) {
            x.warn("Error in onConnect handler:", R);
          }
        o.current = !1;
      }),
        M.addEventListener("close", (w) => {
          let R = gt(w);
          if (
            (x.debug("close:", R, "clientClosed:", ae.clientClosed, w),
            q !== 0 && (clearInterval(q), (q = 0)),
            j !== 0 && (clearTimeout(j), (j = 0)),
            n.current === ae)
          ) {
            mt(R) || (d.current = !1);
            for (let I of i.current.onDisconnect)
              try {
                I(R);
              } catch (z) {
                x.warn("Error in onDisconnect handler:", z);
              }
            if (((n.current = null), d.current)) {
              let { delay: I, nextReconnectAttempt: z } = ft(R, h.current);
              ((h.current = z), u(I));
            }
          }
        }),
        M.addEventListener("message", (w) => {
          try {
            ...
            if (I.type === "ack") {
              E.acked();
              return;
            } else I.type === "redirect" && (s.current = I.value.url);
            for (let z of i.current.onMessage)
              try {
                z(I);
              } catch (Je) {
                x.warn("Error in onMessage handler:", Je);
              }
          } catch (R) {
            x.warn("Error receiving:", R);
          }
        }),
        (n.current = ae));
    }, [e]);
  ...
  let C = (0, v.useCallback)(
    ({ online: u, visible: g }) => {
      u && (g || D.isApiPlugin) ? p() : D.isApiPlugin || y();
    },
    [p]
  );
  return (
      ...
      () => ({
        ...
        send(u) {
          if (n.current?.ws.readyState !== 1) {
            u.type !== "state" && x.warn("Dropping", u.type, "message.");
            return;
          }
          try {
            ...
            x.warn("Error sending", u.type, "message:", g);
          }
        },
        forceReconnect() {
          (n.current &&
...
var St = S("app");
function Tr() {
  (St.reportError("Socket message too big"),
    G({
      type: "add",
      variant: "error",
...
function re(a) {
  return ze(a) && "session" in a;
}
function ne(a) {
  return ze(a) && "changes" in a && Array.isArray(a.changes);
}
var k = S("remote:sync"),
  We = 2 ** 52,
  oe = class {
    ...
    componentLoader;
    rollingDiff = null;
    session = Math.floor(Math.random() * We);
    seq = 0;
    treeVersion = 0;
    updatesSeen = 0;
    init = 0;
    ...
    setTree(e, t, r) {
      (k.info("setTree", t),
        ...
        r?.isLoading &&
          ((this.rollingDiff = new Re()), this.rollingDiff.addChanges(r?.initialChanges)),
        (this.treeVersion = t),
        (this.waitingForTree = !1),
        (this.hasError = !1),
    ...
    resetSession() {
      ((this.treeVersion = 0),
        (this.session = Math.floor(Math.random() * We)),
        (this.localUpdatesInFlight = []),
    ...
    loadOneScope(e, t) {
      ...
      if (e.__class === "WebPageNode" || e.__class === "SmartComponentNode") {
        (Ee(e), (n.tree = n.tree.commitWithLoadedScope(this.componentLoader, e)));
      ...
      if (this.rollingDiff) {
        ...
        i.size > 0 ? ce(l, i) && N(n.tree, l) : N(n.tree, l);
      } else {
        let l = 0,
          h = i.size > 0,
        ...
        for (let y of r.entries) {
          if (l > m) break;
          (l++,
            !y.wasScopeInsert && ((h && !ce(y.changes, i)) || ((h = !1), N(n.tree, y.changes))));
        }
      }
      s === -1
...
var U = S("remote:sync"),
  ie = class extends oe {
    ...
    handleRemoteUpdate(e) {
      ...
      if (((this.updatesSeen += 1), (this.treeVersion = t), re(e) && e.session === this.session)) {
    ...
    rebaseRemoteTreeWithChanges(e, t, r) {
      ...
      for (let d = 0; d < r; d++) {
        let l = o[d];
        (N(e, l.changes), (e = e.commitDiffs(this.componentLoader)));
    ...
    commitAndCreateUpdate(e = 0) {
      (c(D.isTest), this.timeline.commitLocalTree());
      let t = this.createUpdateToSend();
      return t ? De(t, e) : null;
    }
...
var vt = { cache: !0, update: !0, mutable: !0, children: !0 };
function Tt(a, e) {
  if (a !== "cached") return e;
}
function qe(a) {
  return JSON.parse(JSON.stringify(a, Tt));
}
function $e(a, e, t) {
  let r = new Set(),
    n = !1;
...
var H = S("remote:connection"),
  ...
  Ge = class {
    constructor(e, t, r, n, o) {
      ...
      this.projectId = r;
      this.callbacks = n;
      (c(e instanceof Ue, "timeline must be a TreeTimeline"),
        (this.treeSync = new ie(e, t)),
...
`)
      ...
      try {
        ...
        for (; this.remoteUpdates.length > 0; ) {
          ...
          ((e = t),
            ...
            this.loader && !re(t) && this.loader.addNodeChanges(t.changes));
        }
        if (this.loader) {
    ...
    createLoader(e, t, r) {
      this.loader?.scheduler.cancel();
      let n = new he(this.componentLoader, t, e, r);
    ...
    async loadServerTree(e, t, r) {
      c(!e || pe(e), "treeData must be a string");
      let n,
        o = new he(this.componentLoader, r, t, {
          partialParsing: !0,
          loadInBackground: !0,
          loadedData: e,
...
var dn = ["Today", "Yesterday", "Last 7 days", "Last 30 days", "Last 90 days", "Month to Date"];
function bt(a) {
  switch (a) {
    case "Today":
      return 0;
...
//# sourceMappingURL=https://app.framerstatic.com/chunk-EQOWXM3Y.mjs.map
