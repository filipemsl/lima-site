...
import { C as f, a as p, r as re, t as ie } from "./motion.CA7Ore89.mjs";
import {
  I as m,
  O as h,
  T as g,
...
function de() {
  ...
  let n = null,
    r = !1;
  if (t.location.ancestorOrigins && t.location.ancestorOrigins.length > 0) {
    let e = t.location.ancestorOrigins[0];
    try {
      n = new URL(e).host;
    } catch {}
  ...
  return (n && (r = n === C || n.endsWith(`.${C}`)), r);
}
function fe(e) {
  return o((n, r) => {
    let i = d(w, T, E),
      a = b.current() === b.canvas;
    return i && !a
      ? null
      : s(e, {
          ...n,
          ...
          onClick: (e) => {
            (e.preventDefault(),
              t.open(
                `https://www.framer.com/r/badge/?utm_campaign=freeplanbadge&utm_source=${encodeURIComponent(t?.location?.origin)}`
              ));
          },
          ...
          className: n.className + ` __framer-badge`,
        });
  });
}
function pe(e) {
...
var C,
  ...
  he = e(() => {
    (u(),
      ...
      (P.displayName = `Text`),
      g(P, {
        Z1QnXqTEb: { defaultValue: `rgb(0, 0, 0)`, hidden: !1, title: `Fill`, type: y.Color },
        vtL2DrqsL: { defaultValue: `rgb(0, 0, 0)`, hidden: !0, title: `Fill 2`, type: y.Color },
      }));
  }),
  F,
  I,
...
e(() => {
  (u(),
    ...
    (U = m(H)),
    (W = m(P)),
    (G = x(P, { nodeId: `pBR1Ew0r8`, override: pe, scopeId: `PX9hIOIVM` })),
    (K = ae(ue(x(f.a, { nodeId: `HK2sXlagE`, override: fe, scopeId: `PX9hIOIVM` })))),
    (q = `framer-6jWyo`),
    ...
    (ye = ({ value: e, children: t }) => {
      ...
      return s(p.Provider, { value: a, children: t });
    }),
    (be = f.create(n)),
    ...
    (Q = v(
      o(function (e, t) {
        ...
        le();
        let { style: c, className: u, layoutId: ne, variant: d, ...p } = xe(e),
          {
            baseVariant: ie,
            classNames: m,
            ...
            setVariant: b,
            variants: x,
          } = ce({ defaultVariant: `HK2sXlagE`, ref: r, variant: d, variantClassNames: J }),
          S = Se(e, x),
          ue = h(q);
        return s(re, {
          id: ne ?? i,
            ...
            children: s(ye, {
              ...
              children: s(oe, {
                ...
                children: l(K, {
                  ...
                  __targetOpacity: 1,
                  className: `${h(ue, `framer-n0ccwk`, u, m)} framer-bmpgw8`,
    ...
    S(Q, [{ explicitInter: !0, fonts: [] }, ...U, ...W], { supportsExplicitInterCodegen: !0 }),
    ($ = {
      exports: {
...
//# sourceMappingURL=PX9hIOIVM.Dn69prUG.mjs.map
