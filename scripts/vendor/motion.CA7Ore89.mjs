...
function Mt() {
  if (Dl) {
    ...
    (t.forEach((e) => {
      ...
      e.forEach((e) => {
        e.suspendedScrollY !== void 0 && r.scrollTo(0, e.suspendedScrollY);
      }));
  }
...
function en(e, t, n = 1) {
  ...
  let [i, a] = $t(e);
  if (!i) return;
  let o = r.getComputedStyle(t).getPropertyValue(i);
  if (o) {
    let e = o.trim();
    return Is(e) ? parseFloat(e) : e;
  }
  return _c(a) ? en(a, t, n + 1) : a;
}
function tn(e) {
  let t = [{}, {}];
  return (
...
function pn(e, t, { delay: n = 0, transitionOverride: i, type: a } = {}) {
  let { transition: o, transitionEnd: s, ...c } = t,
  ...
  let f = [],
    ...
    m = o?.path;
  m && m.animateVisualElement(e, c, o, n, f);
  for (let t in c) {
    let i = e.getValue(t, e.latestValues[t] ?? null),
      a = c[t];
    if (a === void 0 || (p && fn(p, t))) continue;
    let s = { delay: n, ...Zt(o || {}, t) };
    d && (s.skipAnimations = !0);
    let l = i.get();
    if (l !== void 0 && !i.isAnimating() && !Array.isArray(a) && a === l && !s.velocity) {
      z.update(() => i.set(a));
      continue;
    }
    let m = !1;
    if (r.MotionHandoffAnimation) {
      let n = dn(e);
      if (n) {
        let e = r.MotionHandoffAnimation(n, t, z);
        e !== null && ((s.startTime = e), (m = !0));
      }
    }
    ln(e, t);
    let h = u ?? e.shouldReduceMotion;
    i.start(ou(t, i, a, h && cu.has(t) ? { type: !1 } : s, e, m));
    let g = i.animation;
    g && f.push(g);
  }
  if (s) {
  ...
  return (
    i.forEach((e) => {
      let n = !1,
        ...
        u = () => {
          ((n = !0),
            r.addEventListener(`pointerup`, l, a),
            r.addEventListener(`pointercancel`, l, a));
        },
        d = (e) => {
      ...
      (e.addEventListener(
        ...
        (n) => {
          ...
          i = !1;
          let r = t(e, n);
          typeof r == `function` && ((o = r), e.addEventListener(`pointerleave`, d, a));
        },
        a
      ),
        e.addEventListener(`pointerdown`, u, a));
    }),
    o
  );
}
...
function Nn(e, t, n = {}) {
  let [i, a, o] = Tn(e, n),
    s = (e) => {
      ...
      (Fu.add(i), n.stopPropagation && Lu.add(e));
      let o = t(i, e),
        s = { ...a, capture: !0 },
        c = (e, t) => {
          (r.removeEventListener(`pointerup`, l, s),
            r.removeEventListener(`pointercancel`, u, s),
            Fu.has(i) && Fu.delete(i),
            Mn(e) && typeof o == `function` && o(e, { success: t }));
        },
        l = (e) => {
          c(e, i === r || i === document || n.useGlobalTarget || ju(i, e.target));
        },
        u = (e) => {
          c(e, !1);
        };
      (r.addEventListener(`pointerup`, l, s), r.addEventListener(`pointercancel`, u, s));
    };
  return (
    i.forEach((e) => {
      ((n.useGlobalTarget ? r : e).addEventListener(`pointerdown`, s, a),
        Sn(e) &&
          (e.addEventListener(`focus`, (e) => Iu(e, a)),
  ...
  return (
    ...
    () => {
      (Uu.delete(e),
        !Uu.size &&
          typeof Wu == `function` &&
          (r.removeEventListener(`resize`, Wu), (Wu = void 0)));
    }
  );
}
function Vn(e, t) {
...
function rr() {
  if (((td.current = !0), nd))
    if (r.matchMedia) {
      let e = r.matchMedia(`(prefers-reduced-motion)`),
...
function bi(e) {
  ...
  if (!t) return;
  let n = dn(t);
  if (r.MotionHasOptimisedAnimation(n, `transform`)) {
    let { layout: t, layoutId: i } = e.options;
    r.MotionCancelOptimisedAnimation(n, `transform`, z, !(t || i));
  }
  let { parent: i } = e;
  i && !i.hasCheckedOptimisedAppear && bi(i);
}
function xi({
  ...
  return class {
    ...
    mount(t) {
      ...
      let { layoutId: n, layout: i, visualElement: a } = this.options;
      if (
        ...
        this.options.animate !== !1 &&
          ...
          this.addEventListener(
            ...
            ({ delta: e, hasLayoutChanged: t, hasRelativeLayoutChanged: n, layout: r }) => {
              ...
              let i = this.options.transition || a.getDefaultTransition() || qd,
              ...
              if (
                ...
                let t = { ...Zt(i, `layout`), onPlay: o, onComplete: s };
    ...
    willUpdate(e = !0) {
      ...
      if (
        (r.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && bi(this),
    ...
    resetTransform() {
      ...
      e &&
        this.instance &&
        (t || dr(this.latestValues) || i) &&
        (a(this.instance, r), (this.shouldResetTransform = !1), this.scheduleRender());
    }
    measure(e = !0) {
...
function Yi({ children: e, isPresent: t, anchorX: r, anchorY: i, root: a, pop: o }) {
  let s = h(),
    c = b(null),
    l = b({ width: 0, height: 0, top: 0, left: 0, right: 0, bottom: 0, direction: `ltr` }),
    { nonce: u } = y($),
    d = Ji(c, e.props?.ref ?? e?.ref);
  return (
    w(() => {
      let { width: e, height: n, top: d, left: f, right: p, bottom: m, direction: h } = l.current;
...
function sa({ children: e, isValidProp: t, ...n }) {
  t && aa(t);
  let r = y($);
  ((n = { ...r, ...n }),
    (n.transition = Xt(n.transition, r.transition)),
...
function da(e) {
  let { initial: t, animate: n } = ua(e, y(mf));
  return l(() => ({ initial: t, animate: n }), [fa(t), fa(n)]);
}
function fa(e) {
...
function ya(e, t, n, { latestValues: r }, i, a = !1, s) {
  let c = ((s ?? va(e)) ? _a : ga)(t, r, i, e),
    u = oa(t, typeof e == `string`, a),
    d = e === o ? {} : { ...u, ...c, ref: n },
    { children: f } = t,
    p = l(() => (X(f) ? f.get() : f), [f]);
...
function Sa(e, t, n, i, a, o) {
  ...
  let g = m.current,
    _ = y(gf);
  g && !g.projection && a && (g.type === `html` || g.type === `svg`) && Ca(m.current, n, a, _);
  let v = b(!1);
  w(() => {
  ...
  let x = n[du],
    S = b(
      !!x && r !== void 0 && !r.MotionHandoffIsComplete?.(x) && r.MotionHasOptimisedAnimation?.(x)
    );
  return (
    N(() => {
      ((h.current = !0),
    ...
    d(() => {
      g &&
        ...
        (S.current &&=
          (queueMicrotask(() => {
            r.MotionHandoffMarkAsComplete?.(x);
          }),
          !1)),
...
function Ta(e, { forwardMotionProps: t = !1, type: n } = {}, i, a) {
  i && ra(i);
  let o = n ? n === `svg` : va(e),
    s = o ? xf : bf;
  function c(n, c) {
    ...
    return x(mf.Provider, {
      value: f,
      children: [
        l && f.visualElement ? g(l, { visualElement: f.visualElement, ...u }) : null,
        ya(e, n, ba(p, f.visualElement, c), p, d, t, o),
      ],
    });
  }
...
function $a(e) {
  let [t, n] = Zi(),
    r = y(Ns);
  return g(Bf, { ...e, layoutGroup: r, switchLayoutGroup: y(gf), isPresent: t, safeToRemove: n });
}
function eo(e, t, n) {
  let { props: r } = e;
...
function go(e, { container: t = document.scrollingElement, trackContentSize: n = !1, ...i } = {}) {
  if (!t) return I;
  let a = dp.get(t);
  a || ((a = new Set()), dp.set(t, a));
  let o = ho(t, e, rp(), i);
  if ((a.add(o), !lp.has(t))) {
    let e = () => {
        for (let e of a) e.measure(V.timestamp);
        z.preUpdate(n);
      },
      n = () => {
    ...
    (r.addEventListener(`resize`, i),
      t !== document.documentElement && up.set(t, Vn(t, i)),
  ...
  return (
    ...
    () => {
      ...
      let i = pp.get(t);
      (i && (B(i), pp.delete(t)), fp.delete(t));
    }
  );
}
function _o(e) {
  return r === void 0 ? !1 : e ? Nl() : Ml();
}
function vo(e) {
...
function Ao(e, t) {
  return r === void 0 ? !1 : e ? Nl() && !!xo(t) : Ml();
}
...
function Ro(e, t = {}) {
  ...
  if (n) return Fo(r);
  let i = Mo(r());
  return (w(() => qn(i, e, t), [i, JSON.stringify(t)]), i);
}
function zo(e, t = {}) {
  ...
  for (let n = 0; n < e.length; n++) {
    ...
    let g = 0,
      _ = (e, n, r, o = 0, s = 0) => {
        ...
        if ((w > 0 && yt(u, w), c.length === 1 && c.unshift(null), m && `${m}${Sp}`, m && m < Sp)) {
          let e = b > 0 ? _ / b : 0;
          b = Yo(b, m, _);
          let t = [...c],
            n = [...u];
        ...
        let T = ee + b;
        (Qo(r, c, y, u, ee, T), (g = Math.max(x + b, g)), (f = Math.max(T, f)));
      };
    if (X(p)) {
      let e = ns(p, s);
      _(m, h, rs(`default`, e));
...
function bs(e, { root: t, margin: n, amount: r, once: i = !1, initial: a = !1 } = {}) {
  let [o, c] = s(a);
  return (
    d(() => {
...
function ws({ children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: i, ...a }, o) {
  let s = M(() => $f[t]),
    ...
    f = {
      ...
      registerItem: (e, t) => {
        ...
        (r === -1 ? c.push({ value: e, layout: t[n] }) : (c[r].layout = t[n]), c.sort(Ts));
      },
      updateOrder: (e, t, n) => {
        if (l.current) return;
        let a = Cs(c, e, t, n);
  ...
  return g(s, {
    ...
    ref: p,
    ignoreStrict: !0,
    children: g(Ap.Provider, { value: f, children: e }),
  });
}
function Ts(e, t) {
...
function ks(e, t, n) {
  let i = t.getBoundingClientRect(),
    a = n === `x` ? Math.max(0, i.left) : Math.max(0, i.top),
    o = n === `x` ? Math.min(r.innerWidth, i.right) : Math.min(r.innerHeight, i.bottom),
    s = e - a,
    c = o - e;
  if (s < Mp) {
    let e = 1 - s / Mp;
...
function As(e, t, n, i) {
  ...
  let a = Os(e, n);
  if (!a) return;
  let { amount: o, edge: s } = ks(t - (n === `x` ? r.scrollX : r.scrollY), a, n);
  if (s === null) {
    (Ip.delete(a), Fp.delete(a));
    return;
  }
  let c = Ip.get(a),
    l = a === document.body || a === document.documentElement;
  if (c !== s) {
    if (!((s === `start` && i < 0) || (s === `end` && i > 0))) return;
    Ip.set(a, s);
    let e =
      n === `x`
        ? a.scrollWidth - (l ? r.innerWidth : a.clientWidth)
        : a.scrollHeight - (l ? r.innerHeight : a.clientHeight);
    Fp.set(a, e);
  }
  if (o > 0) {
    let e = Fp.get(a);
    if ((n === `x` ? (l ? r.scrollX : a.scrollLeft) : l ? r.scrollY : a.scrollTop) >= e) return;
  }
  n === `x`
    ? l
      ? r.scrollBy({ left: o })
...
function Ms(
  ...
  let l = M(() => $f[r]),
    u = y(Ap),
    d = { x: js(t.x), y: js(t.y) },
    f = Fo([d.x, d.y], ([e, t]) => (e || t ? 1 : `unset`)),
    { axis: p, registerItem: m, updateOrder: h, groupRef: _ } = u;
  return g(l, {
    drag: p,
    ...s,
    dragSnapToOrigin: !0,
    ...
    onDrag: (e, t) => {
      let { velocity: r, point: a } = t,
        o = d[p].get();
      (h(n, o, r[p]), As(_.current, a[p], p, r[p]), i && i(e, t));
    },
    onDragEnd: (e, t) => {
      (Es(), a && a(e, t));
    },
...
var Ns,
  ...
  zp = t(() => {
    (f(),
      ...
      (Al = (e) => e.startsWith(`--`)),
      (jl = {}),
      (Ml = It(() => r.ScrollTimeline !== void 0, `scrollTimeline`)),
      (Nl = It(() => r.ViewTimeline !== void 0, `viewTimeline`)),
      (Pl = It(() => {
        try {
      ...
      (Eu = class extends kl {
        ...
        measureInitialState() {
          ...
          (n === `height` && (this.suspendedScrollY = r.pageYOffset),
            (this.measuredOrigin = wl[n](e.measureViewportBox(), r.getComputedStyle(e.current))),
        ...
        measureEndState() {
          ...
          let a = n.length - 1,
            o = n[a];
          ((n[a] = wl[t](e.measureViewportBox(), r.getComputedStyle(e.current))),
      ...
      (ad = class {
        ...
        bindToMotionValue(e, t) {
          ...
          let i = t.on(`change`, (t) => {
            ...
            a;
          (r !== void 0 && r.MotionCheckAppearSync && (a = r.MotionCheckAppearSync(this, e, t)),
            this.valueSubscriptions.set(e, () => {
              (i(), a && a());
            }));
        }
      ...
      (Jd = (e) => T !== void 0 && T.userAgent && T.userAgent.toLowerCase().includes(e)),
      ...
      ($d = xi({
        ...
        defaultParent: () => {
          if (!Qd.current) {
            let e = new Xd({});
            (e.mount(r), e.setOptions({ layoutScroll: !0 }), (Qd.current = e));
          }
          return Qd.current;
        },
        resetTransform: (e, t) => {
        ...
        checkIsScrollRoot: (e) => r.getComputedStyle(e).position === `fixed`,
      })),
      ...
      (tf = ({
            ...
            () => (
              (v = !1),
              {
                ...
                register: (e) => (
                  f.set(e, !1),
                  () => {
                    (f.delete(e), !m.current && !f.size && _.current?.());
                  }
                ),
              }
            ),
        ...
        return (
          ...
          g(Fs.Provider, { value: y, children: e })
        );
      }),
      (nf = (e) => e.key || ``),
      (rf = ({
        ...
        N(() => {
          ...
          for (let e = 0; e < T.length; e++) {
            let t = nf(T[e]);
            h.includes(t) ? (x.delete(t), S.current.delete(t)) : x.get(t) !== !0 && x.set(t, !1);
          }
        }, [T, h.length, h.join(`-`)]);
        let E = [];
        if (m !== ee) {
          ...
          for (let t = 0; t < T.length; t++) {
            let n = T[t],
              r = nf(n);
            h.includes(r) || (e.splice(t, 0, n), E.push(n));
          }
          return (a === `wait` && E.length && (e = E), te(Qi(e)), w(m), null);
        }
        let { forceRender: ne } = y(Ns);
        return g(C, {
          children: T.map((e) => {
            let s = nf(e),
              l = o && !f ? !1 : m === T || h.includes(s);
            return g(
              tf,
              {
                isPresent: l,
      ...
      (of = (e) => e === !0),
      (sf = (e) => of(e === !0) || e === `id`),
      (cf = ({ children: e, id: t, inherit: n = !0 }) => {
        let r = y(Ns),
          i = y(af),
          [a, o] = ea(),
          s = b(null),
        ...
        s.current === null &&
          (sf(n) && c && (t = t ? c + `-` + t : c),
          (s.current = { id: t, group: (of(n) && r.group) || Gi() }));
        let u = l(() => ({ ...s.current, forceRender: a }), [o]);
        return g(Ns.Provider, { value: u, children: e });
      }),
      (lf = c({ strict: !1 })),
      (uf = {
        animation: [
    ...
    ((mf = c({})),
      ...
      (Of = (e, t) => Math.abs(e - t)),
      (kf = (e, t) => ((t.isSVG ?? va(e)) ? new Sd(t) : new hd(t, { allowProjection: e !== o }))),
      ...
      (Mf = class {
        constructor(
          ...
          ((this.dragSnapToOrigin = a),
            ...
            (this.contextWindow = i || r));
          let c = Na(Aa(e), this.transformPagePoint),
            { point: l } = c,
            { timestamp: u } = V;
          this.history = [{ ...l, timestamp: u }];
          let { onSessionStart: d } = t;
          d && d(e, Fa(c, this.history));
          let f = { passive: !0, capture: !0 };
          ((this.removeListeners = zs(
            ja(this.contextWindow, `pointermove`, this.handlePointerMove, f),
            ja(this.contextWindow, `pointerup`, this.handlePointerUp, f),
            ja(this.contextWindow, `pointercancel`, this.handlePointerUp, f)
          )),
        ...
        startScrollTracking(e) {
          ...
          (this.scrollPositions.set(r, { x: r.scrollX, y: r.scrollY }),
            r.addEventListener(`scroll`, this.onElementScroll, { capture: !0 }),
            r.addEventListener(`scroll`, this.onWindowScroll),
            (this.removeScrollListeners = () => {
              (r.removeEventListener(`scroll`, this.onElementScroll, { capture: !0 }),
                r.removeEventListener(`scroll`, this.onWindowScroll));
            }));
        }
        handleScroll(e) {
          ...
          if (!t) return;
          let n = e === r,
            i = n ? { x: r.scrollX, y: r.scrollY } : { x: e.scrollLeft, y: e.scrollTop },
            a = { x: i.x - t.x, y: i.y - t.y };
          (a.x === 0 && a.y === 0) ||
            (n
              ? this.lastMoveEventInfo &&
      ...
      (Ff = class {
        ...
        addListeners() {
          ...
          let e = this.visualElement.current,
            ...
            o = a.addEventListener(`measure`, i);
          (a && !a.layout && (a.root && a.root.updateScroll(), a.updateLayout()), z.read(i));
          let s = gi(r, `resize`, () => this.scalePositionWithinConstraints()),
            c = a.addEventListener(`didUpdate`, ({ delta: e, hasLayoutChanged: t }) => {
              this.isDragging &&
                t &&
                (j((t) => {
                  let n = this.getAxisMotionValue(t);
      ...
      (fp = new WeakMap()),
      (pp = new WeakMap()),
      (mp = (e) => (e === document.scrollingElement ? r : e)),
      (hp = [
        [sp.Enter, `entry`],
        [sp.Exit, `exit`],
        [sp.Any, `cover`],
...
//# sourceMappingURL=motion.CA7Ore89.mjs.map
