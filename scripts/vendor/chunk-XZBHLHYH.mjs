import { b as E, c as W, d as G, e as I } from "./chunk-I6FQ6M5S.mjs";
import { a as o } from "./chunk-3N6HIQYF.mjs";
import { a as s, b as T } from "./chunk-UL4QV65P.mjs";
import { a as c, b as r, c as e } from "./chunk-UZ6VERSV.mjs";
...
var Zr = O(y, n),
  j = { tokens: y, scope: n },
  q = { tokens: V, scope: n };
var nr = { tokens: e, scope: s },
  mr = { tokens: o, scope: s },
  z = a([nr, j]),
  $ = a([mr, q]);
var ir = (t) => (t === "light" ? e : o),
  dr = (t) =>
...
var J = {
  ...
  X = f("light", {}, J),
  Y = f("dark", {}, J);
var Br = { popoverInset: k },
  kr = { tokens: Br, scope: n },
  Z = a([kr]);
var xr = {
  ...
  Tr = { menu: `${g}, 0px 0px 0px 1px ${r.dark72}` },
  hr = {
  ...
  vr = { tokens: hr, scope: s },
  _ = a([vr]),
  Cr = { tokens: xr, scope: s },
  Sr = { tokens: Tr, scope: n },
  rr = a([Cr, Sr]);
var Ir = { tooltipBackground: r.dark81 },
  yr = { tokens: Ir, scope: s },
  or = a([yr]);
var P = {
    light: f(
      "light",
...
var w = i.default.createContext(void 0);
w.displayName = "BaseThemeContext";
var H = i.default.createContext(void 0);
H.displayName = "ThemeOverrideModeContext";
function ar() {
  return i.default.useContext(w);
}
function fr() {
  return i.default.useContext(H);
}
var tr = i.default.forwardRef(function ({ mode: m, children: l, className: p, ...B }, u) {
    let x = fr(),
      d = ar(),
      v = m || x || d,
      lr = Fr(v) ? er[v] : void 0;
    return (0, b.jsx)(H.Provider, {
      value: v,
      children: (0, b.jsx)("div", { ref: u, className: L(cr, lr, p), ...B, children: l }),
    });
  }),
  fe = i.default.memo(function ({ mode: m, children: l }) {
    let p = ar();
    return (
      M(
        p === void 0,
      ...
      (0, b.jsx)(w.Provider, { value: m, children: (0, b.jsx)(tr, { children: l }) })
    );
  }),
  te = i.default.memo(function ({ children: m }) {
    let l = fr();
    return (0, b.jsx)(tr, { mode: l === "warning" ? "warningReset" : l, children: m });
  });
export { Zr as a, ar as b, fr as c, tr as d, fe as e, te as f };
//# sourceMappingURL=https://app.framerstatic.com/chunk-XZBHLHYH.mjs.map
