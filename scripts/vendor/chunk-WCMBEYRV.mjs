...
function I(e) {
  return function ({ children: n, ...o }) {
    ...
    return N(e, i, r) ? c.default.createElement(c.default.Fragment, null, n) : null;
  };
}
function H(e, t) {
  m = !0;
...
function F() {
  ...
  return (
    (n === "alpha" || n === "local" || r) && Object.assign(e, O, P),
    n === "beta" && Object.assign(e, O),
    e
  );
}
function X() {
  let e = {};
  try {
    let t = JSON.parse(localStorage[S()] || "{}");
    Object.assign(e, t);
  } catch {}
  return e;
}
...
function Re({ resetStorage: e, resetSession: t } = {}) {
  if (!(typeof window > "u")) {
    if ((e && localStorage.removeItem(S()), t)) {
...
//# sourceMappingURL=https://app.framerstatic.com/chunk-WCMBEYRV.mjs.map
