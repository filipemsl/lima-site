...
function Dn(o) {
  ...
  for (let n = 0; n < r.length; n++) {
    ...
    let d = e.value.get(i);
    if (a.endsWith(".children") && d === lt) {
      t.add(i);
      continue;
    }
    if (a.endsWith(".children") && d === ze) {
      t.add(i);
      continue;
    }
    let l = dr(d);
...
function hr(o, e) {
  ...
  for (let i = 0; i < e.length; ++i) {
    ...
    let { written: c } = ur.encodeInto(s, n);
    o.writeBytes(n.subarray(0, c));
  }
...
function hi(o) {
  ...
  for (let [r, n] of t) {
    ...
    let s = i.pop(),
      ...
      c = [],
      d = n.keepRowIdx;
    (h(d !== -1, () => `array reference has no keep row: ${r}`),
      e.id._set(d, a),
      e.key._set(d, s),
      e.value._set(d, []));
  ...
  andNot(e) {
    ...
    for (let r of W(this.seqMapByClient)) {
      ...
      for (let c of W(n)) {
        ...
        if (!d) continue;
        let l = i?.get(c),
          u = l ? d.andNot(l) : d.clone();
        u.count <= 0 || (s.set(c, u), (a += u.count));
      }
      ...
      [...n].map(([i, s]) => [
        ...
        Object.fromEntries(
          [...s].map(([a, c]) => {
            ...
            return (
              C(d.parentFrom) && (d.parentFrom = R(d.parentFrom)),
              C(d.parentTo) && (d.parentTo = R(d.parentTo)),
              [a, d]
            );
          })
        ),
  ...
  decode(e, t) {
    ...
    for (let i = 0; i < r; i++) {
      let s = t.readString(),
        ...
        c = t.readFloat64(),
        d = new k(t.readBytes(c));
      for (; !d.endOfFile(); ) {
        let l = d.readUint32(),
          u = d.readFloat64(),
          f = new k(d.readBytes(u));
        switch (l) {
          case 1129270355:
...
var Et = class {
  ...
  decodeColumns(e, t, r) {
    ...
    for (let i = 0; i < n; i++) {
      ...
      if (c !== a.type)
        throw new Error(
          `Column type does not match in branch "${r}": ${c} (actual) != ${a.type} (expected)`
        );
      a.deserialize(t);
    }
  }
    ...
    for (let e of o.branches.values()) {
      ...
      for (let d = 0; d < r.length; d++) {
        ...
        if (a.has(l)) {
          ...
          if (u === "_deleted") {
            let f = c.get(l);
            f === void 0 && ((f = {}), c.set(l, f));
            let p = f._deleted;
            (p === void 0 || $(i.get(d), s.get(d), i.get(p.row), s.get(p.row))) &&
  ...
  Pt = class {
    ...
    resolveHierarchyNodeChange(e, t) {
      ...
      if (typeof d == "string" && typeof l == "string")
        return (t.add(c), this.createNodeChangeMoved(e, d, l, t));
      if (typeof d == "string") return (t.add(c), this.createNodeChangeRemoved(e, d, t));
      if (typeof l == "string") return (t.add(c), this.createNodeChangeAdded(e, l, t));
    }
  ...
  emitInWindowParentIdRows() {
    ...
    for (let r = this.windowStartIdx; r < e.length; r++) {
      ...
      if (!(c && a !== void 0 && a < this.windowStartIdx)) {
        ...
        (!this.visited.has(s) && !c && !t.inTree(s)) || this.emitParentIdRow(i, r);
      }
    }
  }
  emitRow(e) {
...
var et = class {
  ...
  tt = class {
    ...
    syncRemovedMapSetIndex(e, t, r, n, i = !1, s = !1) {
      ...
      let d = e.getOwned(r);
      (d?.reset(n), s && d?.size === 0 && !c && e.delete(r));
    }
  ...
  rt = class {
    ...
    getLatestReplicaChild(e) {
      ...
      for (let i = 7; i < e.length - 9 + 2; i++)
        if (i !== 9 && ((r = e.slice(0, i)), (n = this.getNodeData(r)), n && this.inTree(r))) {
          ...
          return !c || !this.inTree(a) || c.inMaster !== s ? void 0 : [r, n, a, c];
        }
    }
    computeTreeHash() {
      let e = 0,
    ...
    addChild(e, t, r, n = !1) {
      ...
      let i = e.cachedChildren,
        s = ae(i, t, (a, c) => {
          ...
          h(V(d), () => `invalid key in hierarchy, row ${a}`);
          let l = this.getHierarchyKey(c);
          if ((h(V(l), () => `invalid key in hierarchy, row ${c}`), d < l)) return -1;
          if (d > l) return 1;
    ...
    updateLatestValue(e, t, r) {
      ...
      switch (t) {
        ...
        case "master": {
          ...
          if (l === d || (d && this.indexes.syncRemovedReplicaOwner(d, e), !l)) return;
    ...
    rehydrate(e) {
      ...
      for (let [r, n] of this.parentOverrides)
        for (let [i, s] of n) for (let [a, c] of s) t.set(c.rowIdx, c);
    ...
    applyParentIdRow(e, t, r) {
      let n = this.ensureNodeData(e),
        ...
        c = a.seq.get(t),
        d = a.client.get(t);
      if (s === void 0 || $(c, d, a.seq.get(s), a.client.get(s))) {
    ...
    getOwnParentBySeq(e, t, r) {
      ...
      for (let a of n.parentIdHistory) {
        let c = i.seq.get(a);
        if (c > t || (!r && c === t)) continue;
        let d = i.client.get(a);
        if (!s || c > s.seq || (c === s.seq && d > s.client)) {
          let l = i.id.get(a),
            u = this.getParentOverride(l, c, d);
          s = {
            id: l,
            seq: c,
            client: d,
          ...
          for (let [c, d] of a)
            if (!(c < e)) {
              ...
              for (let [l, u] of d) {
                ...
                let x = u.parentFrom === b ? (this.getParentBySeq(s, c)?.value ?? b) : u.parentFrom,
                  O = N(x);
                if (O !== m && O !== b) {
    ...
    createOverrideHierarchyKey(e, t) {
      ...
      if (d)
        for (let u of d.keys()) {
          ...
          if (!a(p)) continue;
          let y = p[p.length - 1];
          y.position === s.position && c.add(y.client);
        }
      let l = rr.find((u) => !c.has(u));
      return (
    ...
    resolveCycles(e) {
      ...
      this.parentHistory.sort((i, s) => {
        let a = n.seq.get(i),
          c = n.seq.get(s);
        return a === c ? n.client.get(i) - n.client.get(s) : a - c;
      });
    ...
    resolveCycleForRow(e, t, r) {
      ...
      let c = a === b ? this.getParentBySeq(i, s) : void 0,
        d = c ? N(c.value) : N(a),
        l = this.findAncestorIdsBefore(d, i, s);
      if (l) {
...
var ot = class {
  ...
  computeCurrentGeneration(e, t) {
    ...
    if (
      ...
      n.dependencies.every((c, d) => c.generation === s[d]?.generation)
    )
      return n.generation;
  ...
  collectDependencyLinks(e) {
    ...
    for (; i.length > 0; ) {
      ...
      let c = this.store.getReplayableValue(s, "replicaInfo"),
        d = this.store.getObjectKey(`${s}.replicaInfo`, "master"),
      ...
      if (c != null && c !== m) {
        if (
          ...
          !gn(d) ||
          d !== l ||
          !t.masterIdToReplicaIds.get(d)?.has(s)
        )
          return;
        r.push({ kind: "master", ownerId: s, targetId: d });
        let f = this.store.getObjectKey(`${s}.replicaInfo`, "inheritsFrom");
        if (f !== void 0) {
          if (!gn(f)) return;
          r.push({ kind: "inheritsFrom", ownerId: s, targetId: f });
        }
      } else if (d !== void 0 || l !== void 0) return;
...
var De = class {
    ...
    build() {
      ...
      for (let s = e.length - 1; s >= 0; s--) {
        ...
        (d === st || ne(e, s, d)) && this.setAt(a, c, s);
      }
    }
    replayLatestValues(e, t) {
      ...
      for (let l = i.length - 1; l >= 0; l--) {
        ...
        let y = p * n + f,
          g = d[y];
        (g === 0 || ne(i, l, g - 1)) &&
          ((d[y] = l + 1), t(this.idCol.uniques[p], this.keyCol.uniques[u], l));
      }
    }
    get(e, t) {
    ...
    *values() {
    ...
    setAt(e, t, r) {
      ...
      ((this.arena[c] = t), (this.arena[c + 1] = r), (this.len[e] = s + 1), this.upd[e]++);
    }
    ensureNode(e) {
...
function ko(o, e, t) {
  ...
  for (;;) {
    ...
    let s = n < o.length,
      a = n < e.length,
      c = s ? o[n] : { position: Oo, client: To },
      d = a && !i ? e[n] : { position: No, client: Mo };
      ...
      Rn
        ...
        : e.length === 0
          ...
          : i
            ? (l = (f, p) => xn(f, p, 8192, 2))
            : (l = Do);
      let u = l(c.position + 1, d.position - 1);
      return (r.push({ position: u, client: t }), r);
    }
    if ((r.push({ ...c }), !i)) {
      let l = c.position < d.position,
...
var qo = ["__class", "isMaster", "isFormContainer", "replicaInfo", "master", "dataIdentifier"],
  ut = class o {
    ...
    authorizeNodeWrite(e, t, r) {
      let n = this.getWriteAuthorizer();
      if (!n) return;
      let i = G(this.hierarchy, e) ?? e,
        s = i === e ? t : e.slice(i.length + 1).split(".", 1)[0];
      n.authorizeNodeWrite(this, i, s, r);
    }
    ...
    runMutation(e) {
      ...
      try {
        ...
        for (let l = 0; l < r; l++) {
          ...
          i[l] = { id: a.get(u), key: c.get(u), value: d.get(u) };
          let p = t.previousIndices[l],
            y = p === -1 ? u : p;
          n.push({ id: a.get(y), key: c.get(y), value: p === -1 ? s : d.get(p) });
        }
      ...
      let t = [],
        ...
        n = (s) => {
          ...
          for (let [l, u] of c) {
            ...
            (t.push({ id: s, key: l, value: f }), d ? n(l) : i(f));
          }
        },
        i = (s) => {
          if (F(s) || ee(s) || Y(s)) {
    ...
    addSerializableRows(e, { authorize: t = !1 } = {}) {
      this.throwIfPermanentError();
      let r = 1 / 0;
      for (let n of e) {
        let i = n.value;
        (w(i) && (i = S(i)),
          this.addRowData(n.id, n.key, i, n.client, n.seq, n.user, n.batch, t),
          (r = Math.min(r, n.seq)));
      }
      (this.sortedArrayCache.clear(), this.hierarchy.postProcess(this.base ? 0 : r));
    }
    addRows(e) {
      this.throwIfPermanentError();
      let t = 1 / 0;
    ...
    replayRowList(e, t) {
      ...
      let n = new Map(),
        ...
        c = t?.regenerateHierarchyPositions ? Po(e) : void 0;
      return (
        this.batch(() => {
          let d = this.seq,
            l = d;
          for (let u of e) {
            ...
            this.addRowData(u.id, u.key, f, this.client, d++, u.user ?? this.user);
          }
    ...
    updateKeyValue(e, t, r) {
      ...
      this.addRowData(e, t, r, this.client, this.seq, this.user, void 0, !0);
    }
    addRowData(e, t, r, n, i, s, a, c = !1) {
      if (!this.shouldAddRow(e, t, r, i, n)) return;
      (c && this.authorizeNodeWrite(e, t, r), this.capturePreviousIndex(e, t, r));
      ...
      (d.client.add(n),
        ...
        d.user.add(s),
        a && d.batch.add(a));
      let l = d.client.length - 1;
      this.updateRowIndex(l, i, e, t, r, n, a);
    }
    ...
    updateRowIndex(e, t, r, n, i, s, a) {
      ...
      if ((this.branchOwnWriteIndex?.indexOwnRow(e), n === "parentid")) {
        ...
        (c === void 0 || $(t, s, d.seq.get(c), d.client.get(c))) &&
    ...
    createHierarchyKey(e, t, r = -1) {
      ...
      let l = c ? this.hierarchy.getChildPosition(c) : void 0,
    ...
    resolveObjectInArrayReference(e, t, r, n) {
      ...
      if (i === void 0) {
        let c;
        (n && Tn(t)
          ? (c = `__${r}_${this.client.toString(36)}`)
          : typeof t.id == "string"
            ? (c = t.id)
    ...
    setObjectKey(e, t, r) {
      ...
      if (r instanceof er) {
        ...
        (this.setObject(d, r.value), this.updateKeyValue(e, t, fn(d)));
        return;
      }
      if (re(r)) {
        let c = F(i) ? A(i) : void 0,
          d = c ?? this._getIdFromObject(r) ?? this.createStoreId(e, t);
        (this.setObject(d, r), (!c || this.inserting) && this.updateKeyValue(e, t, Vt(d)));
        return;
      }
      if (!Array.isArray(r)) {
      ...
      if (Nn(r) || (r.length === 0 && Y(i))) {
        ...
        try {
          (this.setMergeableArray(d, r),
            (!c || this.inserting || n) && this.updateKeyValue(e, t, Ut(d)));
        } finally {
          this.inserting = u;
        }
        return;
    ...
    setObjectKeyPath(e, t, r) {
      ...
      for (let s = 0; s < t.length - 1; ++s) {
        ...
        if ((d || (this.setObjectKey(n, a, {}), (d = this.getCurrentValue(n, a))), !F(d))) {
          let l = t.slice(0, s + 1);
          throw new Error(`${l.join(".")} is not an object`);
        }
        (c === b && this.updateKeyValue(n, a, d), (n = A(d)));
      }
      let i = t[t.length - 1];
      ...
      for (let c of r) {
        ...
        switch (c.operation) {
          case "delete":
            ...
            break;
          case "insert": {
            let l = Be(s[c.index - 1], s[c.index], this.positionClientId);
            (this.updateKeyValue(e, d, l), s.splice(c.index, 0, l), a++);
            break;
          }
        }
      }
        ...
        for (let [s, a] of i)
          for (let [c, d] of a) {
            ...
            h(
              l === d,
              () =>
                `Update row count does not match batch row count. Batch: ${c} Update count: ${d} Batch count: ${l}`
            );
          }
    }
...
//# sourceMappingURL=https://app.framerstatic.com/chunk-Q3T3SIQM.mjs.map
